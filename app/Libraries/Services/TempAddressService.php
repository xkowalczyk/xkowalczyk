...
class TempAddressService
{
    ...
    {
        $this->addressModel = model(TempAddressModel::class);
    }
    ...
    public function getNewAddressId($userId)
    {
        $allUserAddress = $this->getUserAddress($userId);
        return $newAddressId = end($allUserAddress)->address_id;
    }
